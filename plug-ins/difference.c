...
/* 
 * Takes the absolute value of the difference between corresponding 
 *  pixels of the 2 input images.
 */
...
static void difference (Image, Image);
  ...
  if (gimp_init (argc, argv))
    {
      ...
      /* Create a dialog.
       */
      dialog_ID = gimp_new_dialog ("Difference");

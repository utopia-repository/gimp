...
/* 
 * Multiplies corresponding pixels of the 2 input images together.
 */
...
static void multiply (Image, Image);
  ...
  if (gimp_init (argc, argv))
    {
      ...
      /* Create a dialog.
       */
      dialog_ID = gimp_new_dialog ("Multiply");
